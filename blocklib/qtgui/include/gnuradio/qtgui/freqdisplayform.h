...
public:
    ...
    gr::kernel::fft::window::win_type getFFTWindowType() const;
...
public slots:
    ...
    void setFFTWindowType(const gr::kernel::fft::window::win_type);
...
signals:
    ...
    void signalFFTWindow(gr::kernel::fft::window::win_type win);
...
private:
    ...
    int d_fftsize;
    float d_fftavg;
    gr::kernel::fft::window::win_type d_fftwintype;
    double d_units;
