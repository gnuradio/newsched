...
atsc_sync::sptr atsc_sync::make(float rate) { return std::make_shared<atsc_sync>(rate); }

atsc_sync::atsc_sync(float rate)
...
// void atsc_sync::forecast(int noutput_items, gr_vector_int& ninput_items_required)
// {
...
work_return_code_t atsc_sync::work(std::vector<block_work_input>& work_input,
