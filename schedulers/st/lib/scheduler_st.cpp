...
void scheduler_st::notify_upstream(scheduler_sptr upstream_sched, int64_t blkid)
{
...
void scheduler_st::notify_downstream(scheduler_sptr downstream_sched, int64_t blkid)
{
