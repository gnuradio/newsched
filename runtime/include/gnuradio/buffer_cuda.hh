...
{
public:
    buffer_cuda_reader(buffer_sptr buffer,  std::shared_ptr<buffer_properties> buf_props, size_t read_index)
...
#define BUFFER_CUDA_ARGS_H2D buffer_cuda_properties::make(buffer_cuda_type::H2D)
#define BUFFER_CUDA_ARGS_D2H buffer_cuda_properties::make(buffer_cuda_type::D2H)
#define BUFFER_CUDA_ARGS_D2D buffer_cuda_properties::make(buffer_cuda_type::D2D)
