                                ...
                                std::shared_ptr<buffer_properties> buffer_properties)
{
    ...
    if (bp != nullptr) {
        ...
        case vmcirc_buffer_type::SYSV_SHM:
            return buffer_sptr(
                new vmcircbuf_sysv_shm(num_items, item_size, buffer_properties));
        case vmcirc_buffer_type::MMAP_SHM:
            return buffer_sptr(
                new vmcircbuf_mmap_shm_open(num_items, item_size, buffer_properties));
        default:
...
vmcirc_buffer::add_reader(std::shared_ptr<buffer_properties> buf_props)
{
