...
cuda_buffer::~cuda_buffer() { cudaFree(_device_buffer); cudaFree(_host_buffer); }
...
std::shared_ptr<buffer_reader> cuda_buffer::add_reader(std::shared_ptr<buffer_properties> buf_props)
{
